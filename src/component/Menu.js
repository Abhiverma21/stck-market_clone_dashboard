  ...
  return (
    <div className="menu-container">
      ...
      <div className="menus">
        <ul>
          <li>
            <Link style={{textDecoration:"none"}} to="/" onClick={()=> handleMenuLink(0)}>
          ...
          <li>
          <Link style={{textDecoration:"none"}} to="/holdings" onClick={()=> handleMenuLink(2)}>
          <p className={selectedMenu === 2 ? activeMenuClass : menuClass}>Holdings</p></Link>
          </li>
          <li>
          <Link style={{textDecoration:"none"}} to="/positions" onClick={()=> handleMenuLink(3)}>
          <p className={selectedMenu === 3 ? activeMenuClass : menuClass}>Positions</p></Link>
          </li>
          <li>
          <Link style={{textDecoration:"none"}} to="/funds" onClick={()=> handleMenuLink(4)}>
          <p className={selectedMenu === 4 ? activeMenuClass : menuClass}>Funds</p></Link>
          </li>
          <li>
          <Link style={{textDecoration:"none"}} to="/apps" onClick={()=> handleMenuLink(5)}>
        ...
        <div className="profile" onClick={handleProfileClick}>
          ...
          <p className="username">Abhi Verma  </p>
        </div>
